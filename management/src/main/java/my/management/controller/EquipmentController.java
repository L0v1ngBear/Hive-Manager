...
public class EquipmentController {
    ...
    @GetMapping("/page")
    @RequirePermission(value = PermissionCodeEnum.CODE_EQUIPMENT_LIST, message = "您没有权限查看设备巡检")
    ...
    @RequirePermission(value = PermissionCodeEnum.CODE_EQUIPMENT_DETAIL, message = "您没有权限查看设备详情")
    ...
    @RequirePermission(value = PermissionCodeEnum.CODE_EQUIPMENT_INSPECTION_LIST, message = "您没有权限查看巡检记录")
    ...
    @RequirePermission(value = PermissionCodeEnum.CODE_EQUIPMENT_INSPECTION_SUBMIT, message = "您没有权限提交巡检记录")
