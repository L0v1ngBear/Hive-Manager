...
public interface EmployeeMapper extends BaseMapper<Employee> {
    ...
    @Select({
            ...
            "ext.email AS email, u.phone, u.status AS status, ext.entry_date AS entryDate, ext.avatar_url AS avatarUrl, ",
            "u.manager_id AS leaderId, leader.name AS leaderName, ext.remark AS remark ",
            "FROM user u ",
