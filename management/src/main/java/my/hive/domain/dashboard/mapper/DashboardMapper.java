package my.hive.domain.dashboard.mapper;
...
import my.hive.domain.dashboard.model.vo.DashboardInventoryTrendRowVO;
import my.hive.domain.dashboard.model.vo.DashboardInventoryWarningRowVO;
