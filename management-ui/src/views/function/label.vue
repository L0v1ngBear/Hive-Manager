  ...
  <div class="label-print-page function-page-shell font-body">
    <header class="label-print-header">
      ...
      <div class="header-actions">
        ...
        <el-tooltip :disabled="canSaveTemplate" :content="`暂无 ${templateSavePermission} 权限`"><span><el-button :disabled="!canSaveTemplate" @click="openTemplateEditor">
    ...
    <section v-if="showTemplateEditor" class="template-editor-panel">
      ...
      <div class="template-actions">
        ...
        <el-tooltip :disabled="canSaveTemplate" :content="`暂无 ${templateSavePermission} 权限`"><span><el-button type="primary" :disabled="!canSaveTemplate || savingTemplate" :loading="savingTemplate" @click="saveCurrentTemplate">
...
const canCreateTemplate = computed(() => userStore.hasPermission('print:label:create'))
const canUpdateTemplate = computed(() => userStore.hasPermission('print:label:update'))
const templateSavePermission = computed(() => selectedTemplate.value?.id ? 'print:label:update' : 'print:label:create')
const canSaveTemplate = computed(() => selectedTemplate.value?.id ? canUpdateTemplate.value : canCreateTemplate.value)
