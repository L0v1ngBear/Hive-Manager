  ...
  <section class="manual-page">
    <div class="manual-hero">
      ...
      <div class="manual-hero__card">
        ...
        <p>组织资料 → 员工与角色 → 客户项目 → 订单 → 库存与打印 → 大盘与 AI 建议</p>
      </div>
    </div>
...
const sections = [
  {
    ...
    steps: [
      {
        title: '1. 登录并确认组织',
        content: '使用管理员分配的账号密码登录。进入系统后先看右上角组织信息，确认当前进入的是自己的企业组织。'
      },
      {
        title: '2. 配置角色与权限',
  ...
  },
  {
    ...
    steps: [
      ...
      {
        title: '现场操作',
        content: '员工可以在小程序完成考勤打卡、订单查看、库存扫码出入库、质量异常登记和待办处理。'
      },
      {
        title: '模板同步',
...
const faqs = [
  ...
  },
  {
    ...
    answer: '先刷新页面并确认当前组织。如果仍异常，请联系管理员查看操作记录，并提供操作时间、页面名称和业务编号。'
  }
]
