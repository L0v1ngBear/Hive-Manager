...
assertContains(approvalView, `approval:auditor:list`, 'approval owner configuration dialog must use the V3 list permission')
assertContains(approvalView, `approval:auditor:setting`, 'approval owner saving must use the V3 setting permission')
