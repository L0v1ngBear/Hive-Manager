...
CREATE TABLE `approval_auditor_candidate` (
  ...
  `approval_mode` varchar(8) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'AND' COMMENT 'snapshot: AND all approve, OR any approves',
...
CREATE TABLE `approval_default_auditor` (
  ...
  `approval_mode` varchar(8) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'AND' COMMENT 'AND all approve, OR any approves',
