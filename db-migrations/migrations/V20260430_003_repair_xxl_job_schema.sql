-- Repair migration for production cases where schema_migration_history and
-- real MySQL state diverge, leaving the xxl_job database missing.
-- Keep this migration idempotent: never drop or overwrite existing XXL-JOB data.
