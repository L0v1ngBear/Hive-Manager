-- V20260705_001_order_permission_manifest_repair.sql
-- Purpose:
-- 1. Ensure unified order permissions are created by the deployment migration flow.
-- 2. Migrate old sales/production order role permissions and user overrides.
-- 3. Hide old sales/production order permission nodes after the migration.
...
INNER JOIN (
    ...
    UNION ALL SELECT 'order:list', 3, 1, '查看订单列表'
